...
class IssueFetcher:
    ...
    def compare_issues_to_tasks(self, jql_query, assignee_name):
        ...
        jira_task_names = set(
            f"{issue['fields']['summary']} ({issue['key']})" for issue in jira_issues
        )
        ...
        for motion_task in motion_tasks:
            ...
            for jira_issue in jira_issues:
                ...
                if (
                    ...
                    jira_user_id = self.motion_client.get_user_id(jira_assignee_name)
                    ...
                    if jira_user_id is not None:
                        ...
                        print(f"Failed to find Jira user ID for '{jira_assignee_name}'")
...
def main():
    ...
    for assignee_id, assignee_name in assignees.items():
        ...
        issues_result = issue_fetcher.compare_issues_to_tasks(jql_query, assignee_name)
